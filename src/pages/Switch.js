...
export default function Switch() {
    ...
    const onChange = (event) => {
        const payload = { mode: event.target.value };
        dispatch(switchMode(payload))
    }

    return <div className="mode_switch">
        <input
            ...
            onChange={onChange}
        />
        <label className="button_for_radio" htmlFor="runtime">
        ...
        <input
            ...
            onChange={onChange}
        />
        <label className="button_for_radio" htmlFor="build">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
